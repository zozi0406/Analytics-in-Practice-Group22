...
DataExplorer::create_report(credits)

# Calculate Feature Importnace
...
#Class is not included in data definitions to avoid issues with contrast encoding below. It is readed later
...
ggplot(lift(class~predictions,liftset),values=60)
